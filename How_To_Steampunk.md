**The Tampa Hackerspace has many wonderful tools that can be used to
...
Tampa Hackerspace has some wood or other materials available for use.
...
Tampa Hackerspaces' Laser Cutter uses "Corel Draw" for layout and
